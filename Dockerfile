...
VOLUME /tmp
ADD target/MS_search_engine-1.0.4-SNAPSHOT.jar app.jar
...
ENTRYPOINT ["java","-jar","app.jar", "--spring.config.name=application", "--spring.config.location=/app/config/production/backgroundServer/"]
