...
VOLUME /tmp
ADD target/MS_search_engine-1.0.10-SNAPSHOT.jar app.jar
...
ADD src/main/resources/application-production-backgroundMailServer.properties /app/config/production/backgroundMailServer/application.properties
EXPOSE 8080
