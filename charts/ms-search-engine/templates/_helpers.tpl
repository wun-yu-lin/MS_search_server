...
*/}}
{{- define "ms-search-engine.fullname" -}}
...
*/}}
{{- define "ms-search-engine.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "ms-search-engine.fullname" .) .Values.serviceAccount.name }}
{{- else }}
